                    ...
                    return(
                        <React.Fragment>
                            <HeaderDetails className="container-fluid align-items-center">
                                <h1 className="display-1 font-wei-bold">{headerTitle}</h1>
                            ...
                            <div className="container">
                                ...
                                <div className="tab-content mb-5">
                                    ...
                                    role="tabpanel">
                                        ...
                                        <p>{description}</p>
                                        <img src={img} alt={title} className="img-thumbnail img-fuild"></img>
                                    </div>
                                    ...
                                    role="tabpanel">
                                        ...
                                        height: '28.125rem', width: '100%', frameborder:'0'}}></iframe>
                                    </div>
                                </div>
                            </div>
                        </React.Fragment>
...
const HeaderDetails = styled.header`
    background-image: linear-gradient(rgba(109,109,109), rgba(255,255,255));
    height: 100vh;
